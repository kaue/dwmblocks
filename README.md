...
============================
dwmblocks is an status bar for dwm written in c
...
[here in lukes dotfiles repo](https://github.com/LukeSmithxyz/voidrice/tree/master/.local/bin/statusbar).
So if you want my build out of the box, download those and put them in your
`$PATH`. I do this to avoid redundancy in LARBS, both i3 and dwm use the same
statusbar scripts.

Enter the following command to build and install (if
necessary as root):
